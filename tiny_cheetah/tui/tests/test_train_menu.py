...
from tiny_cheetah.tui.train_menu import (
    TrainingCancelled,
    TrainingProcess,
    TrainScreen,
...
from tiny_cheetah.tui.training_path_types import TrainingNode
...
class TestTrainScreen(unittest.TestCase):
    ...
    def test_build_training_settings_uses_selected_backend(self) -> None:
        ...
        with patch("tiny_cheetah.tui.train_menu.get_llm_backend", return_value="torch"):
    ...
    def test_training_process_terminate_logs_runtime_cleanup(self) -> None:
        ...
        with (
            patch("tiny_cheetah.tui.train_menu._run_training_job", side_effect=fake_run_training_job),
            patch("tiny_cheetah.tui.train_menu.relieve_memory_pressure") as relieve_memory,
        ):
